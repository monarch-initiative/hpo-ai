# Contributing to hpo-ai

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
hpo-ai. These guidelines are not strict rules.
...
The hpo-ai team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the hpo-ai technical leads
